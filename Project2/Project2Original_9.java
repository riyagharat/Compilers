...
public class Project2Original_9{
...
simply report such and stop the program. */
    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
      ...
      try{
        ...
        while(input.hasNextLine()){
          ...
          // Checks for comments
          for(Project2Original_9.currentIndex = 0; Project2Original_9.currentIndex < newArray.length; Project2Original_9.currentIndex++){
            if ((Project2Original_9.currentIndex + 1)< newArray.length){
               if (String.valueOf(newArray, Project2Original_9.currentIndex, 2).equals("/*")){
                  commentCounter++;
                 Project2Original_9.currentIndex++;
               }else if (String.valueOf(newArray, Project2Original_9.currentIndex, 2).equals("*/")){
                  if(commentCounter > 0){
                    commentCounter--;
            ...
            if(commentCounter == 0){
              if(!String.valueOf(newArray[Project2Original_9.currentIndex]).equals("\t")){
                compare = compare + newArray[Project2Original_9.currentIndex];
              }
              // If the string matches a keyword
              if(keywords.contains(compare)){
                if(Project2Original_9.currentIndex + 1 < newArray.length){
                  if((String.valueOf(newArray[Project2Original_9.currentIndex + 1]).equals(" "))){
                    Token data = new Token("KEYWORD", compare);
                    tokens.add(data);
                    compare = "";
                  }
                }
                if((Project2Original_9.currentIndex == (newArray.length - 1))){
                  Token data = new Token("KEYWORD", compare);
                  tokens.add(data);
                  compare = "";
                }
                ...
                if((Project2Original_9.currentIndex+1) < newArray.length){
                  if(relational.contains(String.valueOf(newArray, Project2Original_9.currentIndex, 2))){
                    compare = compare + newArray[Project2Original_9.currentIndex+1];
                    Token data = new Token("RELATIONAL", compare);
                    tokens.add(data);
                    compare = "";
                  }else{
                    if(!(relational.contains(String.valueOf(newArray[Project2Original_9.currentIndex-1])))){
                      Token data = new Token("RELATIONAL", compare);
                      tokens.add(data);
                      compare = "";
                    }
                ...
                if(compare.equals("!")){
                  if(Project2Original_9.currentIndex + 1 < newArray.length){
                     if((String.valueOf(newArray[Project2Original_9.currentIndex + 1])).equals("=")){
                        Project2Original_9.currentIndex ++;
                        compare = compare + String.valueOf(newArray[Project2Original_9.currentIndex]);
                        Token data = new Token("RELATIONAL", compare);
                        tokens.add(data);
                        compare = "";
                        Project2Original_9.currentIndex ++;
                  ...
                  for(int z = Project2Original_9.currentIndex; z < newArray.length; z++){
                    if(!(String.valueOf(newArray[z])).equals(" ")){
                      newError = newError + newArray[z];
                    }else{
                      Project2Original_9.currentIndex = z;
                      break;
                    }
                  }
                }
               ...
               // if there is an integer that was read
                ...
                String newNum = "";
                Project2Original_9.isNum = true;
                for(int x = Project2Original_9.currentIndex; x < newArray.length; x++){
                  if((newArray[x] != ' ') && (!(numDelims.contains(String.valueOf(newArray[x]))))){
                    newNum = newNum + newArray[x];
                  }else{
                    Project2Original_9.currentIndex = x-1;
                    checkNum(newNum, errors, tokens);
                    compare = "";
                    Project2Original_9.isNum = false;
                    break;
                  }
                  if(x == (newArray.length - 1)){
                    checkNum(newNum, errors, tokens);
                  }
                  Project2Original_9.currentIndex = x;
                }
                Project2Original_9.isNum = false;
              ...
              // then it is most likely an identifier
              }else if((String.valueOf(newArray[Project2Original_9.currentIndex]).equals(" ")) || (delims.contains(String.valueOf(newArray[Project2Original_9.currentIndex]))) ||
                    (relational.contains(String.valueOf(newArray[Project2Original_9.currentIndex])))){
                String newID = "";
                String testString = "";
                String beforeTest = "";
                ...
                if((!(keywords.contains(compare)))&&(!(relational.contains(compare)))&&(!(delims.contains(compare)))
                      &&(!(errors.contains(compare)))&&(!(compare).equals(" "))&&(Project2Original_9.isNum == false)){
                  ...
                  if(newID.isEmpty() == false){
                    if(keywords.contains(newID)){
                      ...
                      Identifier data3 = new Identifier(newID, Project2Original_9.depthCount, 0);
              ...
              }else if(Project2Original_9.currentIndex == (newArray.length - 1)){
                String newID = "";
                Token data = new Token("", "");
                Token data4 = new Token("", "");
                Token data5 = new Token("", "");
                boolean check = false, check2 = false, check3 = false;
                    ...
                    if(delims.contains(String.valueOf(c))){
                      ...
                      for(int j = p+1; j < newArray.length; j++){
                        if(!(String.valueOf(newArray[j])).equals(" ")){
                          ...
                          Project2Original_9.currentIndex = j;
                          break;
                        }
                      }
                      System.out.println("ERROR: " + newError);
                  ...
                  if(newID.isEmpty() == false){
                    if(keywords.contains(newID)){
                      ...
                      Token data2 = new Token("ID", newID);
                      tokens.add(data2);
                 //     System.out.println("SCOPE: " + Project2Original_9.depthCount);
                    }
                  }
                  if(check3 == true){
                    tokens.add(data5);
    ...
    public static void declarationList(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("EOF"))){
        System.out.println("ACCEPT");
        System.exit(1);
      }else{
    ...
    public static void declarationList2(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("EOF"))){
        ...
        if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("int")) ||
        ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("float")) ||
        ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("void"))){
          typeSpecifier(tokens);
          C(tokens);
          declarationList2(tokens);
        }else{
    ...
    public static void C(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("EOF"))){
        ...
        if((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("ID")){
          Project2Original_9.currentIndexParse++;
          X(tokens);
          return;
        }else{
          System.out.println("ERROR: Expecting ID got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
          System.out.println("REJECT");
          System.exit(1);
        }
      }
    ...
    public static void X(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken().equals("("))){
        Project2Original_9.currentIndexParse++;
        params(tokens);
        compoundStmt(tokens);
        return;
    ...
    public static void Y(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken().equals("["))){
        if((tokens.get(Project2Original_9.currentIndexParse + 1).getTokenType().equals("NUM"))){
          Project2Original_9.currentIndexParse++;
          if((tokens.get(Project2Original_9.currentIndexParse + 1).getToken().equals("]"))){
            Project2Original_9.currentIndexParse++;
            if((tokens.get(Project2Original_9.currentIndexParse + 1).getToken().equals(";"))){
              Project2Original_9.currentIndexParse++;
              Project2Original_9.currentIndexParse++;
              ...
              System.out.println("ERROR: Expecting ; got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
              System.out.println("REJECT");
              System.exit(1);
            }
          }else{
          ...
          System.out.println("ERROR: Expecting NUM got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
          System.out.println("REJECT");
          System.exit(1);
        }
      }else if((tokens.get(Project2Original_9.currentIndexParse).getToken().equals(";"))){
        Project2Original_9.currentIndexParse++;
        return;
      }else{
        System.out.println("ERROR: Expecting ; or [ got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void typeSpecifier(ArrayList<Token> tokens){
      if(!(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("int")) ||
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("void")) ||
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("float")))){
         System.out.println("ERROR: Expecting int or void or float got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
         System.out.println("REJECT");
         System.exit(1);
       }
       Project2Original_9.currentIndexParse++;
    ...
    public static void params(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("void")) &&
        ((tokens.get(Project2Original_9.currentIndexParse + 1).getToken()).equals(")"))){
          Project2Original_9.currentIndexParse = Project2Original_9.currentIndexParse + 2;
        return;
      }else if(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("int")) ||
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("void")) ||
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("float"))){
          param(tokens);
          paramList2(tokens);
    ...
    public static void statementList2(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("ID")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("(")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("if")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("NUM")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals(";")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("while")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("return")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("{"))){
        statement(tokens);
        statementList2(tokens);
        return;
    ...
    public static void statement(ArrayList<Token> tokens){
      ...
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("("))){
        ...
        compoundStmt(tokens);
        return;
      }else if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("if")){
        selectionStmt(tokens);
        return;
      }else if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("while")){
        iterationStmt(tokens);
        return;
      }else if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("return")){
        returnStmt(tokens);
        return;
      }
    }
    ...
    public static void selectionStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("if")){
        if((tokens.get(Project2Original_9.currentIndexParse ++).getToken()).equals("(")){
          Project2Original_9.currentIndexParse++;
          expression(tokens);
          if((tokens.get(Project2Original_9.currentIndexParse ++).getToken()).equals(")")){
        ...
        System.out.println("ERROR: Expecting if got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void T(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("else")){
        Project2Original_9.currentIndexParse++;
        statement(tokens);
        return;
      }else{
    ...
    public static void iterationStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("while")){
        if((tokens.get(Project2Original_9.currentIndexParse + 1).getToken()).equals("(")){
          Project2Original_9.currentIndexParse++;
          expression(tokens);
          statement(tokens);
        ...
        System.out.println("ERROR: Expecting while got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void returnStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("return")){
        Project2Original_9.currentIndexParse++;
        expressionStmt(tokens);
        return;
      }else{
        System.out.println("ERROR: Expecting return got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void expression(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("ID")){
      ...
      }else if((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("NUM")){
          Project2Original_9.currentIndexParse++;
          term2(tokens);
          B(tokens);
          S(tokens);
        ...
        System.out.println("ERROR: Expecting ID, (, or NUM got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void relop(ArrayList<Token> tokens){
      if(!(((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("<=")) ||
       ...
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("==")) ||
       ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("!=")))){
         System.out.println("ERROR: Expecting <= or < or > or >= or == or != got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
         System.out.println("REJECT");
         System.exit(1);
       }
       Project2Original_9.currentIndexParse++;
    ...
    public static void factor(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("(")){
      ...
      }else if((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("ID")){
        Project2Original_9.currentIndexParse++;
        E(tokens);
        return;
      }else if((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("NUM")){
        ...
        System.out.println("ERROR: Expecting NUM, ID, or ( got: " + (tokens.get(Project2Original_9.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void args(ArrayList<Token> tokens){
      if(((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("ID")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getToken()).equals("(")) ||
      ((tokens.get(Project2Original_9.currentIndexParse).getTokenType()).equals("NUM"))){
        expression(tokens);
        argsList2(tokens);
        return;
      }else{
