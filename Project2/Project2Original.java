    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
      ...
      try{
        ...
        while(input.hasNextLine()){
          ...
          for(Project2Original.currentIndex = 0; Project2Original.currentIndex < newArray.length; Project2Original.currentIndex++){
            if ((Project2Original.currentIndex + 1)< newArray.length){
               if (String.valueOf(newArray, Project2Original.currentIndex, 2).equals("/*")){
                  commentCounter++;
                 Project2Original.currentIndex++;
               }else if (String.valueOf(newArray, Project2Original.currentIndex, 2).equals("*/")){
                  if(commentCounter > 0){
                    commentCounter--;
                  }else if(commentCounter == 0){
                    compare = compare + newArray[Project2Original.currentIndex];
                  }
                  Project2Original.currentIndex++;
               }else if (String.valueOf(newArray, Project2Original.currentIndex, 2).equals("//")){
                 break;
            ...
            if(commentCounter == 0){
              if(!String.valueOf(newArray[Project2Original.currentIndex]).equals("\t")){
                compare = compare + newArray[Project2Original.currentIndex];
              }
      //        System.out.println("String: " + compare);
              if(keywords.contains(compare)){
                ...
                if((Project2Original.currentIndex+1) < newArray.length){
                  if(relational.contains(String.valueOf(newArray, Project2Original.currentIndex, 2))){
                    compare = compare + newArray[Project2Original.currentIndex+1];
                    System.out.println("RELATIONAL: " + compare);
                    compare = "";
                  }else{
                    if(!(relational.contains(String.valueOf(newArray[Project2Original.currentIndex-1])))){
                      System.out.println("RELATIONAL: " + compare);
                      compare = "";
                    }
                  }
                ...
                if(compare.equals("!")){
                  if(Project2Original.currentIndex + 1 < newArray.length){
                     if((String.valueOf(newArray[Project2Original.currentIndex + 1])).equals("=")){
                        Project2Original.currentIndex ++;
                        compare = compare + String.valueOf(newArray[Project2Original.currentIndex]);
                        System.out.println("RELATIONAL: " + compare);
                        compare = "";
                        Project2Original.currentIndex ++;
                  ...
                  for(int z = Project2Original.currentIndex; z < newArray.length; z++){
                    if(!(String.valueOf(newArray[z])).equals(" ")){
                      newError = newError + newArray[z];
                    }else{
                      Project2Original.currentIndex = z;
                      break;
                    }
                  }
                }
                ...
                String newNum = "";
                Project2Original.isNum = true;
                for(int x = Project2Original.currentIndex; x < newArray.length; x++){
                  if((newArray[x] != ' ') && (!(numDelims.contains(String.valueOf(newArray[x]))))){
                    newNum = newNum + newArray[x];
   //                 System.out.println("hello" + newNum);
                  }else{
                    Project2Original.currentIndex = x;
                    checkNum(newNum, errors);
                    compare = "";
                    Project2Original.isNum = false;
                    break;
                  }
                ...
                compare = "";
              }else if((String.valueOf(newArray[Project2Original.currentIndex]).equals(" ")) || (delims.contains(String.valueOf(newArray[Project2Original.currentIndex]))) ||
                    (relational.contains(String.valueOf(newArray[Project2Original.currentIndex])))){
                String newID = "";
                String testString = "";
                String beforeTest = "";
                ...
                compare = "";
              }else if(Project2Original.currentIndex == (newArray.length - 1)){
                    ...
                    if(delims.contains(String.valueOf(c))){
                      ...
                      for(int j = p+1; j < newArray.length; j++){
                        if(!(String.valueOf(newArray[j])).equals(" ")){
                          ...
                          Project2Original.currentIndex = j;
                          break;
                        }
                      }
                      System.out.println("ERROR: " + newError);
