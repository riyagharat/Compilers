...
public class Project2Original_6{
...
simply report such and stop the program. */
  ...
  //        System.out.println("error: " + error);
    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
      ...
      //      System.out.println("INPUT: " + text);
          ...
          for(Project2Original_6.currentIndex = 0; Project2Original_6.currentIndex < newArray.length; Project2Original_6.currentIndex++){
            if ((Project2Original_6.currentIndex + 1)< newArray.length){
               if (String.valueOf(newArray, Project2Original_6.currentIndex, 2).equals("/*")){
                  commentCounter++;
                 Project2Original_6.currentIndex++;
               }else if (String.valueOf(newArray, Project2Original_6.currentIndex, 2).equals("*/")){
                  if(commentCounter > 0){
                    commentCounter--;
                  }else if(commentCounter == 0){
                    compare = compare + newArray[Project2Original_6.currentIndex];
                  }
                  Project2Original_6.currentIndex++;
               }else if (String.valueOf(newArray, Project2Original_6.currentIndex, 2).equals("//")){
                 break;
            ...
            if(commentCounter == 0){
              if(!String.valueOf(newArray[Project2Original_6.currentIndex]).equals("\t")){
                compare = compare + newArray[Project2Original_6.currentIndex];
              }
              System.out.println("String: " + compare);
              if(keywords.contains(compare)){
                if(Project2Original_6.currentIndex + 1 < newArray.length){
                  if((String.valueOf(newArray[Project2Original_6.currentIndex + 1]).equals(" "))){
                    Token data = new Token("KEYWORD", compare);
                    tokens.add(data);
                    compare = "";
                  }
                }
                if((Project2Original_6.currentIndex == (newArray.length - 1))){
                  Token data = new Token("KEYWORD", compare);
                  tokens.add(data);
                  compare = "";
                }
                ...
                if((Project2Original_6.currentIndex+1) < newArray.length){
                  if(relational.contains(String.valueOf(newArray, Project2Original_6.currentIndex, 2))){
                    compare = compare + newArray[Project2Original_6.currentIndex+1];
                    Token data = new Token("RELATIONAL", compare);
                    tokens.add(data);
                    compare = "";
                  }else{
                    if(!(relational.contains(String.valueOf(newArray[Project2Original_6.currentIndex-1])))){
                      Token data = new Token("RELATIONAL", compare);
                      tokens.add(data);
                      compare = "";
                    }
                ...
                if(compare.equals("!")){
                  if(Project2Original_6.currentIndex + 1 < newArray.length){
                     if((String.valueOf(newArray[Project2Original_6.currentIndex + 1])).equals("=")){
                        Project2Original_6.currentIndex ++;
                        compare = compare + String.valueOf(newArray[Project2Original_6.currentIndex]);
                        Token data = new Token("RELATIONAL", compare);
                        tokens.add(data);
                        compare = "";
                        Project2Original_6.currentIndex ++;
                  ...
                  for(int z = Project2Original_6.currentIndex; z < newArray.length; z++){
                    if(!(String.valueOf(newArray[z])).equals(" ")){
                      newError = newError + newArray[z];
                    }else{
                      Project2Original_6.currentIndex = z;
                      break;
                    }
                  }
                }
    ...
    //            System.out.println(compare + "hi");
                String newNum = "";
                Project2Original_6.isNum = true;
                for(int x = Project2Original_6.currentIndex; x < newArray.length; x++){
                  if((newArray[x] != ' ') && (!(numDelims.contains(String.valueOf(newArray[x]))))){
                    newNum = newNum + newArray[x];
   //                 System.out.println("hello" + newNum);
                  }else{
                    Project2Original_6.currentIndex = x-1;
                    checkNum(newNum, errors, tokens);
                    compare = "";
                    Project2Original_6.isNum = false;
                    break;
                  }
                  if(x == (newArray.length - 1)){
                    checkNum(newNum, errors, tokens);
                  }
                  Project2Original_6.currentIndex = x;
                }
                Project2Original_6.isNum = false;
                ...
                tokens.add(data);
                if(compare.equals("{")){
                  Project2Original_6.depthCount++;
                }else if(compare.equals("}")){
                  Project2Original_6.depthCount--;
                }
                compare = "";
              }else if((String.valueOf(newArray[Project2Original_6.currentIndex]).equals(" ")) || (delims.contains(String.valueOf(newArray[Project2Original_6.currentIndex]))) ||
                    (relational.contains(String.valueOf(newArray[Project2Original_6.currentIndex])))){
                String newID = "";
                String testString = "";
                String beforeTest = "";
                ...
                if((!(keywords.contains(compare)))&&(!(relational.contains(compare)))&&(!(delims.contains(compare)))
                      &&(!(errors.contains(compare)))&&(!(compare).equals(" "))&&(Project2Original_6.isNum == false)){
              ...
              //        System.out.println("ERROR: " + newError);
                  ...
                  if(newID.isEmpty() == false){
                    if(keywords.contains(newID)){
                      data = new Token("KEYWORD", newID);
                      check = true;
                    }else{
                      Identifier data3 = new Identifier(newID, Project2Original_6.depthCount, 0);
                      labelStorage.add(data3);
                      Token data2 = new Token("ID", newID);
                      tokens.add(data2);
                 //     System.out.println("SCOPE: " + Project2Original_6.depthCount);
                    }
                  }
                }
                if (check == true){
                ...
                compare = "";
              }else if(Project2Original_6.currentIndex == (newArray.length - 1)){
                    ...
                    if(delims.contains(String.valueOf(c))){
                      ...
                      for(int j = p+1; j < newArray.length; j++){
                        if(!(String.valueOf(newArray[j])).equals(" ")){
                          ...
                          Project2Original_6.currentIndex = j;
                          break;
                        }
                      }
                  //    System.out.println("ERROR: " + newError);
  ...
  //    C();
  //    declarationList2();
      // if next token is empty then accept
    }

    public static void C(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getTokenType()).equals("ID")){
        Project2Original_6.currentIndexParse++;
        X(tokens);
        return;
      }else{
        System.out.println("ERROR: Expecting ID got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
    ...
    public static void X(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken().equals("("))){
        Project2Original_6.currentIndexParse++;
        params(tokens);
        if((tokens.get(Project2Original_6.currentIndexParse++).getToken().equals(")"))){
          Project2Original_6.currentIndexParse++;
          ...
          System.out.println("ERROR: Expecting ) got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
          System.out.println("REJECT");
          System.exit(1);
        }
      }else{
    ...
    public static void Y(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken().equals("["))){
        if((tokens.get(Project2Original_6.currentIndexParse++).getTokenType().equals("NUM"))){
          if((tokens.get(Project2Original_6.currentIndexParse++).getToken().equals("]"))){
            Project2Original_6.currentIndexParse++;
            return;
          }else{
          ...
          System.out.println("ERROR: Expecting NUM got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
          System.out.println("REJECT");
          System.exit(1);
        }
      }else if((tokens.get(Project2Original_6.currentIndexParse).getToken().equals(";"))){
        Project2Original_6.currentIndexParse++;
        return;
      }else{
        System.out.println("ERROR: Expecting ; or [ got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void typeSpecifier(ArrayList<Token> tokens){
      if(!(((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("int")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("void")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("float")))){
         System.out.println("ERROR: Expecting int or void or float got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
         System.out.println("REJECT");
         System.exit(1);
       }
       Project2Original_6.currentIndexParse++;
    ...
    public static void compoundStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getTokenType()).equals("{")){
        Project2Original_6.currentIndexParse++;
    ...
    public static void selectionStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("if")){
        if((tokens.get(Project2Original_6.currentIndexParse ++).getToken()).equals("(")){
          Project2Original_6.currentIndexParse++;
          expression(tokens);
          if((tokens.get(Project2Original_6.currentIndexParse ++).getToken()).equals(")")){
        ...
        System.out.println("ERROR: Expecting if got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void T(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("else")){
        Project2Original_6.currentIndexParse++;
        statement(tokens);
        return;
      }else{
    ...
    public static void iterationStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("while")){
        if((tokens.get(Project2Original_6.currentIndexParse ++).getToken()).equals("(")){
          Project2Original_6.currentIndexParse++;
          expression(tokens);
          if((tokens.get(Project2Original_6.currentIndexParse ++).getToken()).equals(")")){
        ...
        System.out.println("ERROR: Expecting while got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void returnStmt(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("return")){
        Project2Original_6.currentIndexParse++;
        expressionStmt(tokens);
        return;
      }else{
        System.out.println("ERROR: Expecting return got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void expression(ArrayList<Token> tokens){
      if((tokens.get(Project2Original_6.currentIndexParse).getTokenType()).equals("ID")){
      ...
      }else if((tokens.get(Project2Original_6.currentIndexParse++).getToken()).equals("NUM")){
          Project2Original_6.currentIndexParse++;
          term2(tokens);
          B(tokens);
          S(tokens);
        ...
        System.out.println("ERROR: Expecting ID, (, or NUM got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
    ...
    public static void relop(ArrayList<Token> tokens){
      if(!(((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("<=")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("<")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals(">")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals(">=")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("==")) ||
       ((tokens.get(Project2Original_6.currentIndexParse).getToken()).equals("!=")))){
         System.out.println("ERROR: Expecting <= or < or > or >= or == or != got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
         System.out.println("REJECT");
         System.exit(1);
       }
       Project2Original_6.currentIndexParse++;
    ...
    public static void factor(ArrayList<Token> tokens){
      ...
      }else if((tokens.get(Project2Original_6.currentIndexParse).getTokenType()).equals("ID")){
        Project2Original_6.currentIndexParse++;
        E(tokens);
        return;
      }else if((tokens.get(Project2Original_6.currentIndexParse).getTokenType()).equals("NUM")){
        Project2Original_6.currentIndexParse++;
        return;
      }else{
        System.out.println("ERROR: Expecting NUM, ID, or ( got: " + (tokens.get(Project2Original_6.currentIndexParse).getToken()));
        System.out.println("REJECT");
        System.exit(1);
      }
    }
