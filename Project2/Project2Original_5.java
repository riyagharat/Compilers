...
public class Project2Original_5{
...
simply report such and stop the program. */
      ...
      public static void main(String[] args) throws FileNotFoundException{
        ...
        lexical(keywords, relational, delims, errors, labelStorage, numDelims, file);
    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
        ArrayList<String> errors, ArrayList<Identifier> labelStorage, ArrayList<String> numDelims, File file){
   ...
   //                 System.out.println("hello" + newNum);
                ...
                if((!(keywords.contains(compare)))&&(!(relational.contains(compare)))&&(!(delims.contains(compare)))
                  ...
                  if(newID.isEmpty() == false){
                    Identifier data = new Identifier(newID, Project2Original_3.depthCount, 0);
    ...
    public static void syntax(File outputFile){
