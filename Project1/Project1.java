...
public class Project1{
     ...
     * @param num : the string of numbers generated
    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
      ...
      try{
        ...
        while(input.hasNextLine()){
          ...
          // Checks for comments
          for(Project1.currentIndex = 0; Project1.currentIndex < newArray.length; Project1.currentIndex++){
            if ((Project1.currentIndex + 1)< newArray.length){
               if (String.valueOf(newArray, Project1.currentIndex, 2).equals("/*")){
                  commentCounter++;
                 Project1.currentIndex++;
               }else if (String.valueOf(newArray, Project1.currentIndex, 2).equals("*/")){
                  if(commentCounter > 0){
                    commentCounter--;
                  }else if(commentCounter == 0){
                    compare = compare + newArray[Project1.currentIndex];
                  }
                  Project1.currentIndex++;
               }else if (String.valueOf(newArray, Project1.currentIndex, 2).equals("//")){
                 break;
            ...
            if(commentCounter == 0){
              if(!String.valueOf(newArray[Project1.currentIndex]).equals("\t")){
                compare = compare + newArray[Project1.currentIndex];
              }
              ...
              // If there a relational operator that matches the string
                ...
                if((Project1.currentIndex+1) < newArray.length){
                  if(relational.contains(String.valueOf(newArray, Project1.currentIndex, 2))){
                    compare = compare + newArray[Project1.currentIndex+1];
                    System.out.println("RELATIONAL: " + compare);
                    compare = "";
                  }else{
                    if(!(relational.contains(String.valueOf(newArray[Project1.currentIndex-1])))){
                      System.out.println("RELATIONAL: " + compare);
                      compare = "";
                    }
                  }
              ...
              // if there is an error in the string
                ...
                String newError = "";
                for(int z = Project1.currentIndex; z < newArray.length; z++){
                  if(!(String.valueOf(newArray[z])).equals(" ")){
                    newError = newError + newArray[z];
                  }else{
                    Project1.currentIndex = z;
                    break;
                  }
                }
              ...
              }else if((String.valueOf(newArray[Project1.currentIndex]).equals(" ")) || (delims.contains(String.valueOf(newArray[Project1.currentIndex]))) ||
                    (relational.contains(String.valueOf(newArray[Project1.currentIndex])))){
                String newID = "";
                String testString = "";
                String beforeTest = "";
              ...
              }else if(Project1.currentIndex == (newArray.length - 1)){
