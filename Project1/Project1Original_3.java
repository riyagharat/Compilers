...
public class Project1{
  ...
  //              if(compare.equals("*/")){
  //                commentCounter--;
  //                System.out.println("comment2: " + commentCounter);
  //              }
  //              if(commentCounter != 0){
  //                comment = true;
  //              }
        ...
        //        compare = "";
                ...
                String newNum = compare;
    //            for (int p = (i+1); p < newArray.length; p++){
    //              if(!(String.valueOf(newArray[p]).equals(" "))){
    //                if(isInteger(String.valueOf(newArray[p])) == true){
    //                  newNum = newNum + newArray[p];
    //                }
    //              }
    //            }
  ...
  /*              int p = i + 1;
                while(p < newArray.length){
                  if(!(delims.contains(String.valueOf(newArray[p]))) && (!(String.valueOf(newArray[p]).equals(" ")))){
                    if(isInteger(String.valueOf(newArray[p]))){
                      newNum = newNum + newArray[p];
                    }
                  }
                }
                ...
                if((!(keywords.contains(compare)))&&(!(relational.contains(compare)))&&(!(delims.contains(compare)))
                  ...
                  for(int k = 0; k < compare.length(); k++){
                    ...
                    if(delims.contains(String.valueOf(c))){
                      ...
                      System.out.println("ERROR: " + String.valueOf(c));
                      break;
                    }else{
                      newID = newID + c;
                    }
