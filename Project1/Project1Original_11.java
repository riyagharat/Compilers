...
public class Project1Original_11{
    ...
    public static void lexical(ArrayList<String> keywords, ArrayList<String> relational, ArrayList<String> delims,
      ...
      try{
        ...
        while(input.hasNextLine()){
          ...
          for(Project1Original_11.currentIndex = 0; Project1Original_11.currentIndex < newArray.length; Project1Original_11.currentIndex++){
            if ((Project1Original_11.currentIndex + 1)< newArray.length){
               if (String.valueOf(newArray, Project1Original_11.currentIndex, 2).equals("/*")){
                  commentCounter++;
                 Project1Original_11.currentIndex++;
               }else if (String.valueOf(newArray, Project1Original_11.currentIndex, 2).equals("*/")){
                  if(commentCounter > 0){
                    commentCounter--;
                  }else if(commentCounter == 0){
                    compare = compare + newArray[Project1Original_11.currentIndex];
                  }
                  Project1Original_11.currentIndex++;
               }else if (String.valueOf(newArray, Project1Original_11.currentIndex, 2).equals("//")){
                 break;
            ...
            if(commentCounter == 0){
              if(!String.valueOf(newArray[Project1Original_11.currentIndex]).equals("\t")){
                compare = compare + newArray[Project1Original_11.currentIndex];
              }
      //        System.out.println("String: " + compare);
              if(keywords.contains(compare)){
                ...
                if((Project1Original_11.currentIndex+1) < newArray.length){
                  if(relational.contains(String.valueOf(newArray, Project1Original_11.currentIndex, 2))){
                    compare = compare + newArray[Project1Original_11.currentIndex+1];
                    System.out.println("RELATIONAL: " + compare);
                    compare = "";
                  }else{
                    if(!(relational.contains(String.valueOf(newArray[Project1Original_11.currentIndex-1])))){
                      System.out.println("RELATIONAL: " + compare);
                      compare = "";
                    }
                  }
                ...
                if(compare.equals("!")){
                  if(Project1Original_11.currentIndex + 1 < newArray.length){
                     if((String.valueOf(newArray[Project1Original_11.currentIndex + 1])).equals("=")){
                        Project1Original_11.currentIndex ++;
                        compare = compare + String.valueOf(newArray[Project1Original_11.currentIndex]);
                        System.out.println("RELATIONAL: " + compare);
                        compare = "";
                        Project1Original_11.currentIndex ++;
                  ...
                  for(int z = Project1Original_11.currentIndex; z < newArray.length; z++){
                    if(!(String.valueOf(newArray[z])).equals(" ")){
                      newError = newError + newArray[z];
                    }else{
                      Project1Original_11.currentIndex = z;
                      break;
                    }
                  }
                } 
                ...
                String newNum = "";
                Project1Original_11.isNum = true;
                for(int x = Project1Original_11.currentIndex; x < newArray.length; x++){
                  if((newArray[x] != ' ') && (!(numDelims.contains(String.valueOf(newArray[x]))))){
                    newNum = newNum + newArray[x];
   //                 System.out.println("hello" + newNum);
                  }else{
                    Project1Original_11.currentIndex = x;
                    checkNum(newNum, errors);
                    compare = "";
                    Project1Original_11.isNum = false;
                    break;
                  }
                ...
                compare = "";
              }else if((String.valueOf(newArray[Project1Original_11.currentIndex]).equals(" ")) || (delims.contains(String.valueOf(newArray[Project1Original_11.currentIndex]))) ||
                    (relational.contains(String.valueOf(newArray[Project1Original_11.currentIndex])))){
                String newID = "";
                String testString = "";
                String beforeTest = "";
                ...
                compare = "";
              }else if(Project1Original_11.currentIndex == (newArray.length - 1)){
                    ...
                    if(delims.contains(String.valueOf(c))){
                      ...
                      for(int j = p+1; j < newArray.length; j++){
                        if(!(String.valueOf(newArray[j])).equals(" ")){
                          ...
                          Project1Original_11.currentIndex = j;
                          break;
                        }
                      }
                      System.out.println("ERROR: " + newError);
