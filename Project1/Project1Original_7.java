...
public class Project1Original_7{
    ...
    //        int startEndCommentCounter = 0;
            if ((i + 1)< newArray.length){
               if (String.valueOf(newArray, i, 2).equals("/*")){
                  commentCounter++;
        //          if(String.valueOf(newArray, i, 1).equals("/")){
        //            startEndCommentCounter++;
        //          }
        //          System.out.println("HI: " + startEndCommentCounter);
                 i++;
    ...
    //              }
                 ...
                 break;
    /*           }else if(String.valueOf(newArray, i, 1).equals("/")){
                 if((i-1 > 0) && (i < newArray.length)){
                   if(String.valueOf(newArray[i-1]).equals("*")){
                     startEndCommentCounter--;
                   }else if(String.valueOf(newArray[i+1]).equals("*")){
                     startEndCommentCounter++;
                   ...
                   System.out.println("HI2: " + startEndCommentCounter);*/
               }
            }
            if(commentCounter == 0){
              compare = compare + newArray[i];
